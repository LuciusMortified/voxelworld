...
// Availability is requested per query rather than waited on: a stage that was
// skipped this frame leaves its pair unwritten, and a plain read would report
// the whole range as not ready.
