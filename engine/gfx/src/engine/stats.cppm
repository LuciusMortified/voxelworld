...
struct bench_config {
    ...
    // Тот же отчёт деревом, для тех, кто его читает программой. Пусто — не
    // писать: человеку хватает таблиц, а скриптам разбор таблиц дорого обходится
    // при каждом изменении формата.
