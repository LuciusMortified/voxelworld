...
#ifndef VW_GFX_ANIMATION_STATE_MACHINE_H
#define VW_GFX_ANIMATION_STATE_MACHINE_H
...
class animation_state_machine final {
public:
...
#include "vw/gfx/animation/animation_state_machine.inl.h"

#endif  // VW_GFX_ANIMATION_STATE_MACHINE_H
