...
#ifndef VW_ECS_ANIMATION_PLAYER_COMPONENT_H
#define VW_ECS_ANIMATION_PLAYER_COMPONENT_H
...
#include "vw/ecs/components/animation_player_component.inl.h"

#endif  // VW_ECS_ANIMATION_PLAYER_COMPONENT_H
