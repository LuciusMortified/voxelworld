...
#ifndef VW_ECS_TRANSFORM_COMPONENT_H
#define VW_ECS_TRANSFORM_COMPONENT_H
...
#include "vw/ecs/components/transform_component.inl.h"

#endif  // VW_ECS_TRANSFORM_COMPONENT_H
