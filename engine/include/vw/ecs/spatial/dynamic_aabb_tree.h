...
#ifndef VW_ECS_SPATIAL_DYNAMIC_AABB_TREE_H
#define VW_ECS_SPATIAL_DYNAMIC_AABB_TREE_H
...
#include "vw/ecs/spatial/dynamic_aabb_tree.inl.h"

#endif  // VW_ECS_SPATIAL_DYNAMIC_AABB_TREE_H
