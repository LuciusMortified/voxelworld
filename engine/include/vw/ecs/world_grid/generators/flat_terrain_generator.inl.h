...
#ifndef VW_ECS_WORLD_GRID_GENERATORS_FLAT_TERRAIN_GENERATOR_INL_H
#define VW_ECS_WORLD_GRID_GENERATORS_FLAT_TERRAIN_GENERATOR_INL_H
...
#endif  // VW_ECS_WORLD_GRID_GENERATORS_FLAT_TERRAIN_GENERATOR_INL_H
