...
void vulkan_context::create_instance() {
    ...
    create_info.enabledLayerCount =
        static_cast<uint32>(validation_layers.size());
...
void vulkan_context::pick_physical_device() {
    ...
    std::cout << "Found " << device_count << " devices with vulkan support"
              << std::endl;
    std::cout << std::endl;
...
void vulkan_context::create_logical_device() {
    ...
    create_info.enabledExtensionCount =
        static_cast<uint32>(device_extensions_.size());
...
bool vulkan_context::is_device_suitable(VkPhysicalDevice device) {
    ...
    std::cout << "Checking device: " << device_properties.deviceName
              << std::endl;
    std::cout << "Type: ";
    ...
    std::cout << "  Graphics: "
              << (indices.graphics_family.has_value() ? "Yes" : "No")
              << std::endl;
    std::cout << "  Present: "
              << (indices.present_family.has_value() ? "Yes" : "No")
              << std::endl;

    bool extensions_supported = check_device_extension_support(device);
    std::cout << "Extension Support: " << (extensions_supported ? "Yes" : "No")
              << std::endl;
    ...
    if (extensions_supported) {
        ...
        std::cout << "Swapchain Support: "
                  << (swapchain_adequate ? "Yes" : "No") << std::endl;
        if (!swapchain_adequate) {
            std::cout << "  Formats: " << swapchain_support.formats.size()
                      << std::endl;
            std::cout << "  Present Modes: "
                      << swapchain_support.present_modes.size() << std::endl;
        }
    }
    ...
    std::cout << "Surface Support: " << (surface_support ? "Yes" : "No")
              << std::endl;
