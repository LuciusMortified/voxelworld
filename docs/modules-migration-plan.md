...
| # | Решение | Выбор |
|---|---------|-------|
| D1 | Механизм модулей | Именованные модули C++20/23, партиции; `import std` — **только с M6** (уточнено в M1), до тех пор стандартная библиотека через global module fragment |
