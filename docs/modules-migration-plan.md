...
| M5 | `vw.gfx`: конверсия + миграция на Vulkan-Hpp | **высокий** | ✅ **выполнено частично** (без `deletion_queue` и замера FPS), отчёт: `docs/m5-vw-gfx.md` |
| M6 | Приложения, тесты, зачистка, обновление CLAUDE.md | низкий | ✅ **выполнено**, отчёт: `docs/m6-cleanup.md` |
