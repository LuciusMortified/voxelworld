...
| **Tooling Prototype**  | **Sculptor**: моделирование/анимация и экспорт VOX;  **Architect**: редактирование зданий (поверхностные строения) и комнат подземелий; | Движок загружает VOX‑модель из Sculptor; комната или здание из Architect появляется в мире при процедурной генерации |
