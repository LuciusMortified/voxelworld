...
#ifndef VW_SCULPTOR_ADD_MODEL_COMPONENT_OPERATION_H
#define VW_SCULPTOR_ADD_MODEL_COMPONENT_OPERATION_H
...
#include "add_model_component_operation.inl.h"

#endif  // VW_SCULPTOR_ADD_MODEL_COMPONENT_OPERATION_H
